...
/// <summary>
/// A BootstrapCSS styled generic component that displays a form for editing / creating a model.
/// </summary>
/// <typeparam name="TEntity"></typeparam>
public partial class BsQuickForm<TEntity> : ComponentBase, IDisposable
